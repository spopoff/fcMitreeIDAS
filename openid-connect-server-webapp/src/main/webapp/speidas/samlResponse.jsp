...
<head>
	...
	<script type="text/javascript" src="../speidas/js/script.js"></script>
	<script type="text/javascript" src="../speidas/js/base64.js"></script>
</head>
<body>
	...
	<div class="row">
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane fade in active" id="tab-02">
				...
				<jsp:include page="../speidas/leftColumn.jsp"/>
				<div class="col-md-6">
