...
public class AuthorizationRequestFilter extends GenericFilterBean {
    ...
    private final LoginHintExtracter loginHintExtracter = new RemoveLoginHintsWithHTTP();
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        logger.debug("arrive filtre authRequestFilter de "+request.getServletPath());
        ...
        try {
            ...
            logger.debug("dans filtre authRequest="+authRequest);
            ...
            logger.debug("dans filtre loginHint="+loginHint);
            ...
            if (authRequest.getExtensions().get(PROMPT) != null) {
                ...
                logger.debug("dans filtre no prompt parameter, not our business");
                // no prompt parameter, not our business
                chain.doFilter(req, res);
            }

        } catch (InvalidClientException e) {
            logger.debug("dans filtre exception="+e);
